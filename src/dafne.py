...
#		indice_destino  = 0 
	...
	for punto1 in good_matches:
		...
		for punto2 in good_matches:
			destino = punto2.trainIdx
			dist_2 = distanza (surf_kp2[origine].pt[0] ,surf_kp2[origine].pt[1], surf_kp2[destino].pt[0], surf_kp2[destino].pt[1])
			dist_1 = distanza (surf_kp1[idx1[indice_origine]].pt[0] ,surf_kp1[idx1[indice_origine]].pt[1], surf_kp1[idx1[indice_destino]].pt[0], surf_kp1[idx1[indice_destino]].pt[0])
